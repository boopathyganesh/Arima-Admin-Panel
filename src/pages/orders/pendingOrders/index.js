...
const PendingOrders = () => {
          ...
          <>
            ...
            >
              {params?.row?.orderStatus.toLowerCase() === "pending" ?
                <Typography variant="body2">New Order Placed</Typography>
                :
  ...
  const getOrdersListByStatus = useCallback(() => {
    ...
    orderApi.allOrdersByStatus("PENDING").then(onSuccess, onFailure);
  }, []);
