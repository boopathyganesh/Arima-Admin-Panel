...
const sampleData = [
  {
    ...
    orderId: 'ORD123FD',
    shopRating: 2.5,
    shopFeedback: 'QWERTY QWERTY asdfgh asdfgh sdfgh',
  },
  {
    id: 2,
    customerId: 'PRT453S9W',
        ...
        return (
          <>
            <div className={classesTable.ratings}>
              <Typography variant="body2">
                {params?.row?.shopRating} <StarIcon />
              </Typography>
            </div>
          </>
        )
      ...
      <Grid container style={{ paddingBlock: 20 }}>
        <Grid item xs={12}>
          <section className={classesTable.titleWrapper}>
            <div className={classesTable.title}>
              <Typography variant="h5">Shop Reviews</Typography>
            </div>
        ...
        <Grid item xs={12} className={classesTable.tableWrapper}>
          <CustomDataGrid
            ...
            fileName={'shop_id_shop_reviews_list'}
            customStyle={{
