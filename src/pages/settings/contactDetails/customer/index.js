...
import { createCustomerContact, updateCustomerContactById } from 'redux/slices/customerContact/customerContactSlice';
import { useDispatch, useSelector } from 'redux/store';

const Customer = ({ customerData, isEdit }) => {
  ...
  const handleContactDetails = async (formValues) => {
    ...
    if (isEdit) {
      ...
      await dispatch(updateCustomerContactById(updateData))
    } else {
      await dispatch(createCustomerContact(formValues))
    }
  }
